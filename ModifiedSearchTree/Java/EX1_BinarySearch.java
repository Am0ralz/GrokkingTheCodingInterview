...
// we start by initializing start end and mid and check if its ascending
// we check if for the location fo the key,
// if it's less than we go to check first half ir its more the other half
